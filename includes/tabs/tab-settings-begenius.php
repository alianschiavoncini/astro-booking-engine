...
<div class="section-wrapper box <?php echo esc_attr($provider); ?>">
    <div class="section-wrapper-inner">
        ...
        <table class="form-table">
			<?php
			$field = array(
				'label' => esc_html__( 'Hotel code', 'astro-booking-engine' ),
				'description' => __( 'Found in your BeGenius booking engine address: secure.begenius.it/bookingenius/hotel_web/en/HOTEL-CODE/', 'astro-booking-engine' ),
