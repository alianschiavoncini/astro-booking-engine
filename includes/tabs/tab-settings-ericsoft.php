...
<div class="section-wrapper box <?php echo esc_attr($provider); ?>">
    <div class="section-wrapper-inner">
        ...
        <table class="form-table">
			<?php
			$field = array(
				'label' => esc_html__( 'idh', 'astro-booking-engine' ),
				'description' => false,
				'name' => ASTRO_BE_PREFIX.$provider.'_idh',
				'value' => get_option(ASTRO_BE_PREFIX.$provider.'_idh'),
				'placeholder' => false,
			);
			?>
            <tr>
        ...
        <p class="description"><?php esc_html_e( 'The age ranges of children and infants depend on the age categories configured in your Ericsoft booking engine.', 'astro-booking-engine' ); ?></p>
        <table class="form-table">
			<?php
			$field_label = esc_html__( 'Enable', 'astro-booking-engine' );
			$field_description = __('Check to enable', 'astro-booking-engine' );
