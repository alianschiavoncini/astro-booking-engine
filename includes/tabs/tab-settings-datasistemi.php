...
<div class="section-wrapper box <?php echo esc_attr($provider); ?>">
    <div class="section-wrapper-inner">
        ...
        <table class="form-table">
			<?php
			$field = array(
				'label' => esc_html__( 'idstr', 'astro-booking-engine' ),
				'description' => false,
				'name' => ASTRO_BE_PREFIX.$provider.'_idstr',
				'value' => get_option(ASTRO_BE_PREFIX.$provider.'_idstr'),
				'placeholder' => false,
			);
			?>
            <tr>
        ...
        <p class="description"><?php esc_html_e( 'Children ages cannot be passed to the Data Sistemi booking engine: guests can set them on the booking page.', 'astro-booking-engine' ); ?></p>
        <table class="form-table">
			<?php
			$field_label = esc_html__( 'Enable', 'astro-booking-engine' );
			$field_description = __('Check to enable', 'astro-booking-engine' );
        ...
        <table class="form-table">
			...
			$field_label = esc_html__( 'Enable', 'astro-booking-engine' );
			$field_description = __('Check to enable', 'astro-booking-engine' );
			$field_name = ASTRO_BE_PREFIX.$provider.'_codpromo';
			$field_value = get_option($field_name);
			?>
            <tr>
                <th scope="row"><label for="<?php echo esc_attr($field_name); ?>"><?php echo esc_html($field_label); ?></label></th>
